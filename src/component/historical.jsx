...
import {initDate, getLastYearYestdy,day,month,sort,monthlyStatistics,setDateDate,setMonthDeta,setDateHis} from '../js/main';
    ...
    inquiriesClick(){
        ...
        if(endTime < beginTime){
            ...
            if(type == 0){
                ...
                if(currentMonth == beginTime.substring(4,6)||currentMonth == endTime.substring(4,6) ){
                    alert('不能查询当月记录')
                }else{
                    var data ={
                        "func": 302,
        ...
        return(
            <div>
                <div className="mb24">
                    ...
                    <span className="ml15 font18">
                        类型
                        <select className="select h33 ml15 w185 outline font16" id="type"  onClick={this.typeClick.bind(this)}>
                ...
                <div className="border form">
                    ...
                    <ReactEcharts option={this.getOtion(this)} style={{height: '300', width: '765',left: '-38px', top: '-10'}} className="echarts-for-echarts"/>
            </div>
        )
    }
}
